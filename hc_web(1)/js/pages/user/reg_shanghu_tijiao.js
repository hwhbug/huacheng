mui.init({
			...
			window.addEventListener('adminmp', function(event) {
				...
				mui.ajax('http://101.201.196.202:82/home/Admininfo', {
					data: {
						"adminmp": id
					},
			...
			(function($, doc) {
				...
				$.plusReady(function() {
					...
					shenhezhong.addEventListener('tap', function(event) {
						...
						//****************************用户提交成功返回*********************************
						mui.ajax('http://101.201.196.202:82/home/BusinessAdd', {
							data: {
			...
			// 创建上传任务
			function imgupgrade() {
				var task = plus.uploader.createUpload("http://101.201.196.202:82/home/request_img", {
					method: "post"
				}, function(t, status) {
